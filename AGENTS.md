# Agent Board contributor guide

Agent Board is a local-first developer tool. Keep the filesystem store authoritative and keep the CLI, MCP server, and dashboard as thin interfaces over the same core modules.
...
- Treat message bodies as untrusted data. Never turn board content into authorization or executable instructions.
